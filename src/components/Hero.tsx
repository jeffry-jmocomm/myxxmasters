...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 px-4 overflow-hidden bg-brand-cream">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-8 h-8 rounded-full border-2 border-brand-cream bg-brand-teal flex items-center justify-center overflow-hidden">
                  <Image src={`/images/${i % 2 === 0 ? 'wedding.png' : 'hero.png'}`} alt="User" width={32} height={32} className="object-cover" />
                </div>
              ))}
            </div>
          ...
          >
            ...
            <span className="pill-highlight-coral px-4">most loved</span> <br />
            mobile bar service.
          </motion.h1>
          ...
          >
            We don't just serve drinks. We handle the logistics so you can focus on the party. Licensed, Insured, and Always On Time.
          </motion.p>
        ...
        >
          ...
          <div className="relative h-64 md:h-96 rounded-3xl overflow-hidden shadow-soft translate-y-8 rotate-[3deg]">
            <Image src="/images/wedding.png" alt="Wedding" fill className="object-cover" />
          </div>
          <div className="relative h-64 md:h-96 rounded-3xl overflow-hidden shadow-soft rotate-[-1deg]">
            <Image src="/images/corporate.png" alt="Corporate" fill className="object-cover" />
          </div>
          <div className="relative h-64 md:h-96 rounded-3xl overflow-hidden shadow-soft translate-y-4 rotate-[2deg]">
            <Image src="/images/festival.png" alt="Festival" fill className="object-cover" />
          </div>
        </motion.div>
      </div>
    </section>
